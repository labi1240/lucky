...
import { toggleCasino } from '../app/actions/accountActions';
...
export const EmailViewer: React.FC<EmailViewerProps> = ({ client, onBack, onRefresh }) => {
    const {
        emails,
        loading,
        refreshing,
    ...
    const [copiedSenderEmail, setCopiedSenderEmail] = useState(false);
            ...
            <div className="sticky top-0 z-10 border-b border-slate-200 bg-white">
                <div className="h-14 md:h-16 flex items-center justify-between px-3 md:px-4">
                    <div className="flex items-center space-x-2 md:space-x-4 min-w-0">
                        ...
                        <button
                            onClick={() => handleCopy(client.user_email, setCopiedUserEmail)}
                            className="p-1 hover:bg-slate-100 rounded transition-colors text-slate-400 hover:text-blue-500"
                        ...
                        <div className="flex items-center gap-1.5 ml-2 border-l border-slate-200 pl-4">
                            {[
                                ...
                                return (
                                    <button
                                        key={casino.id}
                                        className={`w-7 h-7 md:w-8 md:h-8 rounded-xl flex items-center justify-center transition-all border shrink-0 ${
                                            isSelected
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                onClick={() => handleCopy(selectedEmail.from, setCopiedSenderEmail)}
                                                className="p-1 hover:bg-slate-100 rounded transition-colors text-slate-400 hover:text-blue-500"
